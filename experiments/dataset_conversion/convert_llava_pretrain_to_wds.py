...
llava_pretrain_dir = '/lustre/share/downloaded/dataset/LLaVA-Pretrain'
output_dir='/lustre/users/spliew/megatron_bridge_vlm/dataset'

# Paths to the dataset files
json_file = os.path.join(llava_pretrain_dir, 'blip_laion_cc_sbu_558k.json')
output = os.path.join(output_dir, 'LLaVA-Pretrain')
